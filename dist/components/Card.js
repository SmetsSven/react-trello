...
class Card extends _react.Component {
  ...
  render() {
    ...
    return _react.default.createElement(_Base.MovableCardWrapper, {
      ...
      style: style,
      className: className
    }, _react.default.createElement(_Base.CardHeader, null, _react.default.createElement(_Base.CardTitle, null, title), _react.default.createElement(_Base.CardRightContent, null, label), showDeleteButton && _react.default.createElement(_DeleteButton.default, {
