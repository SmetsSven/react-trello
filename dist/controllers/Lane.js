...
class Lane extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "renderHeader", () => {
      ...
      const pickedProps = (0, _pick.default)(this.props, ['id', 'label', 'title', 'titleStyle', 'cards', 'labelStyle', 't', 'editLaneTitle', 'canAddLanes']);
  ...
  render() {
    ...
    const _this$props2 = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props2, ["id", "cards", "collapsibleLanes", "components", "onLaneClick", "onLaneScroll", "onCardClick", "onCardAdd", "onCardDelete", "onLaneDelete", "onLaneUpdate", "onCardMoveAcrossLanes"]);
    ...
    }), this.renderHeader(), this.renderDragContainer(isDraggingOver), loading && _react.default.createElement(components.Loader, null), showFooter && _react.default.createElement(components.LaneFooter, {
